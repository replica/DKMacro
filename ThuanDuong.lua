...
function MacroFunctions.ThuanDuongTHC()
  ...
  if bEnable==true and MacroFunctions.StopAction()<=1 and MacroFunctions.CheckMoveState(p,"stand|float|entrap|walk|run|jump") and not MacroFunctions.KTCombo.bEnable then
    ...
    if MacroOptions.autoBaoNguyenThuKhuyetTHC and MP<MacroOptions.MPLimitTHC and K==10 and not MacroFunctions.CheckBuff(p,1916,1,0,0) and not MacroFunctions.CheckBuff(p,613,1,0,0) and MacroFunctions.dwPreparingSkillID~=6901 and MacroFunctions.dwLastSkillIDCasted~=6901 and MacroFunctions.dwLastSkillIDCasted~=6909 then MacroFunctions.use({316},0) end
    ...
    if MacroOptions.autoTuKhiDongLaiTHC and K>=8 and MacroFunctions.CheckBuff(p,375,1,0,0) and MacroFunctions.GetSkillCD(6901)<1.5 and ((MacroFunctions.GetSkillCD(313)>10 and not MacroOptions.cooperateBuffTHC) or MacroFunctions.IsSkillCD(313)) and ((nLeft>10 and not MacroOptions.cooperateBuffTHC) or nLeft==0) then MacroFunctions.use({2681},4,500) end
    --Tự bật Thao Quang Dưỡng Hối
    if MacroOptions.autoThaoQuangDuongHoiTHC and K<=7 and MacroFunctions.CheckBuff(p,375,1,0,0) and ((MacroFunctions.GetSkillCD(2681)>10 and not MacroOptions.cooperateBuffTHC) or MacroFunctions.GetSkillCD(2681)>117) and ((nLeft>10 and not MacroOptions.cooperateBuffTHC) or nLeft>177) then MacroFunctions.use({313},4,500) end
    --Buff thần binh
...
function MacroFunctions.ThuanDuongTHKY()
  ...
  if bEnable==true and MacroFunctions.StopAction()<=1 and MacroFunctions.CheckMoveState(p,"stand|float|entrap|walk|run|jump") and not MacroFunctions.KTCombo.bEnable then
    ...
    --Sử dụng vật phẩm
    if MacroOptions.autoUseWeapon and K>=8 and MacroFunctions.CheckBuff(p,378,1,0,0) and MacroFunctions.GetSkillCD(2699)<1.5 and ((MacroFunctions.GetSkillCD(2681)>10 and not MacroOptions.cooperateBuffTHKY) or MacroFunctions.IsSkillCD(2681)) and ((MacroFunctions.GetSkillCD(313)>10 and not MacroOptions.cooperateBuffTHKY) or MacroFunctions.IsSkillCD(313)) then MacroFunctions.UseEquippedItem(EQUIPMENT_INVENTORY.MELEE_WEAPON) end
    if MacroOptions.autoUseAmulet and K>=8 and MacroFunctions.CheckBuff(p,378,1,0,0) and MacroFunctions.GetSkillCD(2699)<1.5 and ((MacroFunctions.GetSkillCD(2681)>10 and not MacroOptions.cooperateBuffTHKY) or MacroFunctions.IsSkillCD(2681)) and ((MacroFunctions.GetSkillCD(313)>10 and not MacroOptions.cooperateBuffTHKY) or MacroFunctions.IsSkillCD(313)) then MacroFunctions.UseEquippedItem(EQUIPMENT_INVENTORY.AMULET) end
    if MacroOptions.autoUsePendant and K>=8 and MacroFunctions.CheckBuff(p,378,1,0,0) and MacroFunctions.GetSkillCD(2699)<1.5 and ((MacroFunctions.GetSkillCD(2681)>10 and not MacroOptions.cooperateBuffTHKY) or MacroFunctions.IsSkillCD(2681)) and ((MacroFunctions.GetSkillCD(313)>10 and not MacroOptions.cooperateBuffTHKY) or MacroFunctions.IsSkillCD(313)) then MacroFunctions.UseEquippedItem(EQUIPMENT_INVENTORY.PENDANT) end
    --Tự bật Từ Khí Đông Lai
    local bCool,nLeft,nTotal,bBroken=p.GetItemCDProgress(p.GetItem(INVENTORY_INDEX.EQUIP,EQUIPMENT_INVENTORY.PENDANT).dwID)
    if MacroOptions.autoTuKhiDongLaiTHKY and K>=8 and MacroFunctions.CheckBuff(p,378,1,0,0) and MacroFunctions.GetSkillCD(2699)<1.5 and ((MacroFunctions.GetSkillCD(313)>10 and not MacroOptions.cooperateBuffTHKY) or MacroFunctions.IsSkillCD(313)) and ((nLeft>10 and not MacroOptions.cooperateBuffTHKY) or nLeft==0) then MacroFunctions.use({2681},4,500) end
    --Tự bật Thao Quang Dưỡng Hối
    if MacroOptions.autoThaoQuangDuongHoiTHKY and K<=7 and MacroFunctions.CheckBuff(p,378,1,0,0) and ((MacroFunctions.GetSkillCD(2681)>10 and not MacroOptions.cooperateBuffTHKY) or MacroFunctions.GetSkillCD(2681)>117) and ((nLeft>10 and not MacroOptions.cooperateBuffTHKY) or nLeft>177) then MacroFunctions.use({313},4,500) end
    --Duy trì Tọa Vọng Vô Ngã
